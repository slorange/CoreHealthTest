...
VALUES
(   'd5277c15-9672-4e70-ab8f-aaaaaaaaaaaa',   -- InvoiceId - uniqueidentifier
    'f102c51c-fc65-7173-3cc0-fdc51ad91b88',   -- CustomerId - uniqueidentifier
    N'000000001',    -- Reference - nvarchar(255)
    139.95,   -- Total - decimal(18, 2)
    DEFAULT -- Created - datetime
    )

INSERT INTO InvoiceItem ([InvoiceItemId], [InvoiceId], [ItemId], [Quantity], [Created])
VALUES
( '{40cfa695-9e0d-42e6-ae5d-bbbbbbbbbbbb}', '{d5277c15-9672-4e70-ab8f-aaaaaaaaaaaa}', '{e93a3773-fc6f-4ce4-bff1-d388fcd28cb8}', 3, N'2023-04-06T15:56:45.69' )
INSERT INTO InvoiceItem ([InvoiceItemId], [InvoiceId], [ItemId], [Quantity], [Created])
VALUES
( '{40cfa695-9e0d-42e6-ae5d-cccccccccccc}', '{d5277c15-9672-4e70-ab8f-aaaaaaaaaaaa}', '{55ca87d6-b8d4-4fa6-bd92-ac6229052f54}', 2, N'2023-04-06T15:56:45.69' )